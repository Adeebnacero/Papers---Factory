...
public class CommentFactoryTest extends TestCase {
    ...
    //Implementing the Factory of Comment
    Comment comment = CommentFactory.getComment("Yes I like this", date, "192.168.15.29", users, sites, voteUp, voteDown, report, response,filter );
